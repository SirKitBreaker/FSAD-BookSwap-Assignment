      ...
      <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        <div className="w-full order-2 md:order-1 md:w-3/2 mt-12 md:mt-36">
          <div className="space-y-8">
            <h1 className="text-4xl font-bold">Welcome to <span className="text-pink-500"> TReadBooks</span>!</h1> 
            <h1 className="text-4xl font-bold">Explore the World within books!!</h1>
